/**
 * Defines common Stack methods. *  * @author Gerald Page  * @version 1
 */
public interface IStack {
    ...
    /**
     * Returns a formatted string of the stack's logical contents.     *      * @return     logical stack contents as a string
     */
